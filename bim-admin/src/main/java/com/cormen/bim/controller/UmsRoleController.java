...
public class UmsRoleController {
    ...
    @RequestMapping(value = "/allocMenu", method = RequestMethod.PUT)
    @ResponseBody
    ...
    @RequestMapping(value = "/allocPermission",method = RequestMethod.PUT)
    @ResponseBody
    public CommonResult allocPermission(@RequestParam Long roleId,@RequestParam List<Long> permissinIds){
        int count =roleService.allocPermission(roleId,permissinIds);
        return  CommonResult.success(count);
    }
